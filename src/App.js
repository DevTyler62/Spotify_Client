                  ...
                  <Toolbar id="navback">
                    <div id="menuToggle">
                      ...
                      <ul id="menu">
                        ...
                        <a href={"/topTracks/#access_token=" + token}>
                          <li>TOP STATS</li>
                        </a>
                        <a href={"/currentPlayback/#access_token=" + token}>
                          <li>CURRENT SONG</li>
                        </a>
                        <a href={"/playlistData/#access_token=" + token}>
                          <li>PLAYLISTS</li>
                        </a>
                    ...
                    <div id="logo">
                      <a href={"/#access_token=" + token}>
                        <img
                          src="https://i.ibb.co/QC8xjv1/DF2.png"
                          alt="DF2"
                          border="0"
                        ></img>
                      </a>
                    ...
                    <div className="navlinks">
                      <Button
                        className="active"
                        id="links"
                        onClick={this.handleClickTop(topTracksLink)}
                      >
                        {" "}
                        Top Stats
                      </Button>
                      ...
                      <Button
                        className="active"
                        id="links"
                        onClick={this.handleClickCurrent(currentPlaybackLink)}
                      >
                        Now Playing
                      </Button>
                      <Button
                        className="active"
                        id="links"
                        onClick={this.handleClickPlaylist(playlistDataLink)}
                      >
                        Playlist Analytics
                      </Button>
        ...
        {this.state.visible ? (
          <div className="homepage">
            <div className="introduction">
              ...
              <p>
                Get your top tracks, playlists and what you're currently
                listening to visualized.
              </p>
